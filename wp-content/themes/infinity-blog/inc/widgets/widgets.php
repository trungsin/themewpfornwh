...
if (!function_exists('infinity_blog_load_widgets')) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function infinity_blog_load_widgets()
    {
        // Recent Post widget.
...
add_action('widgets_init', 'infinity_blog_load_widgets');
...
if (!class_exists('TWP_sidebar_widget')) :
     ...
     * @since 1.0.0
     */
    class TWP_sidebar_widget extends Infinity_Blog_Widget_Base
    {
        ...
        {
            $opts = array(
                'classname' => 'infinity_blog_popular_post_widget',
                'description' => esc_html__('Displays post form selected category specific for popular post in sidebars.', 'infinity-blog'),
                'customize_selective_refresh' => true,
            );
            $fields = array(
                'title' => array(
                    'label' => esc_html__('Title:', 'infinity-blog'),
                    'type' => 'text',
                    'class' => 'widefat',
                ),
                'post_category' => array(
                    'label' => esc_html__('Select Category:', 'infinity-blog'),
                    'type' => 'dropdown-taxonomies',
                    'show_option_all' => esc_html__('All Categories', 'infinity-blog'),
                ),
                'post_number' => array(
                    'label' => esc_html__('Number of Posts:', 'infinity-blog'),
                    'type' => 'number',
                    'default' => 4,
                    'css' => 'max-width:60px;',
                    'min' => 1,
            ...
            parent::__construct('infinity-blog-popular-sidebar-layout', esc_html__('GW: Recent Post', 'infinity-blog'), $opts, array(), $fields);
        }
                            ...
                            <article class="article-list">
                                <div class="article-image">
                                    <?php if (has_post_thumbnail()) {
                                        $thumb = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'infinity-blog-related-post');
                                        $url = $thumb['0']; ?>
...
if (!class_exists('TWP_Author_Post_widget')) :
     ...
     * @since 1.0.0
     */
    class TWP_Author_Post_widget extends Infinity_Blog_Widget_Base
    {
        ...
        {
            $opts = array(
                'classname' => 'infinity_blog_author_widget',
                'description' => esc_html__('Displays authors details in post.', 'infinity-blog'),
                'customize_selective_refresh' => true,
            );
            $fields = array(
                'title' => array(
                ...
                'author-name' => array(
                    'label' => esc_html__('Name:', 'infinity-blog'),
                    'type' => 'text',
                    'class' => 'widefat',
                ),
                'discription' => array(
                    'label' => esc_html__('Description:', 'infinity-blog'),
                    'type' => 'textarea',
                    'class' => 'widget-content widefat'
                ),
                'image_url' => array(
                    'label' => esc_html__('Author Image:', 'infinity-blog'),
                    'type' => 'image',
                ),
                'url-fb' => array(
                    'label' => esc_html__('Facebook URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-tw' => array(
                    'label' => esc_html__('Twitter URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-gp' => array(
                    'label' => esc_html__('Googleplus URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
            );

            parent::__construct('infinity-blog-author-layout', esc_html__('GW: Author Widget', 'infinity-blog'), $opts, array(), $fields);
        }
...
if (!class_exists('TWP_Social_widget')) :
     ...
     * @since 1.0.0
     */
    class TWP_Social_widget extends Infinity_Blog_Widget_Base
    {
        ...
        {
            $opts = array(
                'classname' => 'infinity_blog_social_widget',
                'description' => esc_html__('Displays Social share.', 'infinity-blog'),
                'customize_selective_refresh' => true,
            );
            $fields = array(
                'title' => array(
                ...
                'url-lt' => array(
                    'label' => esc_html__('Linkedin URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-ig' => array(
                    'label' => esc_html__('Instagram URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-pt' => array(
                    'label' => esc_html__('Pinterest URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-rt' => array(
                    'label' => esc_html__('Reddit URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-sk' => array(
                    'label' => esc_html__('Skype URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-sc' => array(
                    'label' => esc_html__('Snapchat URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-tr' => array(
                    'label' => esc_html__('Tumblr URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-th' => array(
                    'label' => esc_html__('Twitch URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-yt' => array(
                    'label' => esc_html__('Youtube URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-vo' => array(
                    'label' => esc_html__('Vimeo URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-wa' => array(
                    'label' => esc_html__('Whatsapp URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-wp' => array(
                    'label' => esc_html__('WordPress URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-gh' => array(
                    'label' => esc_html__('Github URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-fs' => array(
                    'label' => esc_html__('FourSquare URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-db' => array(
                    'label' => esc_html__('Dribbble URL:', 'infinity-blog'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
            );

            parent::__construct('infinity-blog-social-layout', esc_html__('GW: Social Widget', 'infinity-blog'), $opts, array(), $fields);
        }
