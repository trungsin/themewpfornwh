 ...
 */
class Infinity_Blog_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Infinity_Blog_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Infinity_Blog_Customize_Section_Upsell extends WP_Customize_Section {
